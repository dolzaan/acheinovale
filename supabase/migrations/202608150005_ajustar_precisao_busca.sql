-- Prioriza correspondências fortes e usa aproximação somente como fallback.
DROP INDEX IF EXISTS public.imoveis_vetor_busca_idx;

ALTER TABLE public.imoveis DROP COLUMN IF EXISTS vetor_busca;
ALTER TABLE public.imoveis
  ADD COLUMN vetor_busca tsvector
  GENERATED ALWAYS AS (to_tsvector('simple', documento_busca)) STORED;

CREATE INDEX imoveis_vetor_busca_idx
